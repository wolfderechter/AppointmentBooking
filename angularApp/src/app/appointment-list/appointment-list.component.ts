...
export class AppointmentListComponent implements OnInit {
  ...
  //The cancelAppointment function will send a cancelAppointment request via the service, then it will refetch the appointments (the cancelled appointment should be gone)
